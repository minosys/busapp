...
static void window_load(Window *window) {
  ...
  char* recu = window_get_user_data(s_main_window);
  ...
  if(recu != NULL ) snprintf(msg_buffer, sizeof(msg_buffer), "%s %s .", DIALOG_MESSAGE_WINDOW_MESSAGE, recu);
  else snprintf(msg_buffer, sizeof(msg_buffer), "%s %s .", DIALOG_MESSAGE_WINDOW_MESSAGE, "rien");
  
  text_layer_set_text(s_label_layer, msg_buffer);
...
void dialog_message_window_push(char* message ) {
  ...
  window_set_user_data(s_main_window, message);
